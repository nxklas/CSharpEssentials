...
namespace CSharpEssentials.Mathematics
{
    internal class Noise
    {
      ...
      //  const double scaled_cosine = i = 0.5 * (1.0 - System.Math.Cos(i * System.Math.PI));

      //  double[] perlin; // will be initialized lazily by noise() or noiseSeed()
      ...
      //      if (perlin == null)
      //      {
      //          perlin = (double[])Array.CreateInstance(typeof(double),(int)PERLIN_SIZE + 1);
      //          for (int i = 0; i < PERLIN_SIZE + 1; i++)
      //          {
      //              perlin[i] = new Random().Next();
      //          }
      //      }
      ...
      //      yi = (int)System.Math.Floor(y),
      //      zi = (int)System.Math.Floor(z);
      //      var xf = x - xi;
      //      var yf = y - yi;
      //      var zf = z - zi;
      //      double rxf, ryf;
      ...
      //      for (double o = 0; o < perlin_octaves; o++)
      //      {
      ...
      //          double seed, z;
      //          return {
      //              double setSeed(double val) {
      //                  // pick a random seed if val is undefined or null
      //                  // the >>> 0 casts the seed to an unsigned 32-bit integer
      //                  z = seed = (val == null ? new Random().Next() * m : val) >>> 0;
      //              },
      //double getSeed() {
      //                  return seed;
      //              },
